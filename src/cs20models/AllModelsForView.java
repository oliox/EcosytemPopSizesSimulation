 ...
 * 
 * A sample model class is provided in the form of the GridWorldModel.
...
public class AllModelsForView extends javax.swing.JFrame {
    ...
    public GridWorldModel aGridModel = new GridWorldModel();
    public SimulationRunnerModel theRunner;
